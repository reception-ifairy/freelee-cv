...
- **Legacy persona import** (a resumable, checkpointed MySQL-dump conversion that classifies 122 characters against the live taxonomy and replaces only the audited test dataset atomically) — `50-legacy-persona-import.md`
